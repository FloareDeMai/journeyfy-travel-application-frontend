...
function terms(button) {
  ...
  return (
    <div>
      ...
      <p>Last updated: 2021-09-22</p>
      <p>
        1. <b>Introduction</b>
      </p>
      <p>
        Welcome to <b>frefewrf</b> (“Company”, “we”, “our”, “us”)!
      </p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at <b>journeyfy.com</b> (together or individually
        “Service”) operated by <b>frefewrf</b>.
      </p>
      <p>
      ...
      <p>
        ...
        <b>silviubocsa@gmail.com</b> so we can try to find a solution. These
      ...
      <p>
        ...
        following the unsubscribe link or by emailing at silviubocsa@gmail.com.
      </p>
      ...
      <p>
        Content found on or through this Service are the property of frefewrf or
      ...
      <p>
        ...
        frefewrf and its licensors. Service is protected by copyright,
      ...
      <p>
        ...
        to silviubocsa@gmail.com, with the subject line: “Copyright
      ...
      <p>
        You can contact our Copyright Agent via email at silviubocsa@gmail.com.
      </p>
      <p>
        12. <b>Error Reporting and Feedback</b>
      </p>
      <p>
        You may provide us either directly at silviubocsa@gmail.com or via third
      ...
      <p>
        ...
        are not owned or controlled by frefewrf.
      </p>
      <p>
        frefewrf has no control over, and assumes no responsibility for the
      ...
      <p>
        ...
        of romania, which governing law applies to agreement without regard to
      ...
      <p>
        ...
        email: <b>silviubocsa@gmail.com</b>.
      </p>
      <p style={{marginTop:'5em', fontSize:'0.7em'}}>
        ...
        were created for <b>journeyfy.com</b> by{" "}
        <a href="https://policymaker.io">PolicyMaker.io</a> on 2021-09-22.
      </p>
      {button}
    </div>
  );
